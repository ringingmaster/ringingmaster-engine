 ...
 */
@Immutable
class DefaultCompiledTouch implements CompiledTouch {
	...
	DefaultCompiledTouch(Touch touch, Parse parse, CompileTerminationReason terminationReason, Optional<String> terminateNotes,
