...
import com.concurrentperformance.ringingmaster.engine.touch.impl.DefaultTouch;
...
public class DefaultTouchParserTest {
	...
	private void assertParseType(TouchCell cell, ParseType... parseResult) {
		...
		for (int i=0;i<cell.getLength();i++) {
			assertEquals("parse type index " + i, parseResult[i], cell.getElement(i).getParseType());
		}
	}
