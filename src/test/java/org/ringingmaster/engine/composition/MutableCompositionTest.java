...
public class MutableCompositionTest {
    ...
    public void observerSeesChanges() throws Exception {
        ...
        assertEquals("UNNAMED<0>", argumentMatch1.getAllValues().get(0).getLoggingTag());
        assertEquals("0<1>", argumentMatch1.getAllValues().get(1).getLoggingTag());
        assertEquals("1<2>", argumentMatch1.getAllValues().get(2).getLoggingTag());
