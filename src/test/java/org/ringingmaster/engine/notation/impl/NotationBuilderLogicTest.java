...
public class NotationBuilderLogicTest {
	...
	public NotationBuilderLogicTest(final NumberOfBells numberOFBells, final String placeNotationShorthand, final String expectedResult) {
		super();
	...
	public void impossiblePlacesAreRemoved() {
		...
		assertEquals(expectedResult, notationBody.getNotationDisplayString(false));
	}
