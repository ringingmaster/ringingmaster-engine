...
public class DefaultGroupTest {
    ...
    public void getValuesAsExpected() {
        Group group1 = new DefaultGroup(0, 1, true, Optional.of(TEST_MESSAGE), SECTIONS);
        ...
        assertEquals(TEST_MESSAGE, group1.getMessage().get());

        Section section2 = buildSection(10, 5, CALL);
        HashSet<Section> sections2 = Sets.newHashSet(section2);
        Group group2 = new DefaultGroup(10, 5, false, Optional.of(TEST_MESSAGE), sections2);
    ...
    public void cannotSetNegativeStartIndex() {
        new DefaultGroup(-1, 2, true, Optional.of(TEST_MESSAGE), SECTIONS);
    }
    ...
    public void cannotSetZeroLength() {
        new DefaultGroup(1, 0, true, Optional.of(TEST_MESSAGE), SECTIONS);
    }

    @Test
    public void createStartIndex0OK() {
        new DefaultGroup(0, 1, true, Optional.of(TEST_MESSAGE), SECTIONS);
    }
    ...
    public void fallsWithinBoundsCheck() {
        ...
        Group group = new DefaultGroup(3, 1, true, Optional.of(TEST_MESSAGE), sections2);
    ...
    public void intergroupCheck() {
        ...
        HashSet<Section> sections2 = Sets.newHashSet(section2);
        Group group = new DefaultGroup(3, 3, true, Optional.of(TEST_MESSAGE), sections2);
    ...
    public void canBuildGroupWithCompoundSections() {
        ...
        new DefaultGroup(0, 2, true, Optional.of(TEST_MESSAGE), sections);
    }

    @Test (expected = IllegalArgumentException.class)
    public void cannotBuildGroupWithNoSections() {
        new DefaultGroup(1, 1, true, Optional.of(TEST_MESSAGE), Sets.newHashSet());
    }
    ...
    public void buildingSectionsThatLeaveMidGapInGroupThrows() {
        ...
        new DefaultGroup(0, 3, true, Optional.of(TEST_MESSAGE), sections);
    }
    ...
    public void buildingSectionsThatOverlapsStartOfGroupThrows() {
        ...
        new DefaultGroup(1, 4, true, Optional.of(TEST_MESSAGE), sections);
    }
    ...
    public void buildingSectionsThatIsEncompasesGroupThrows() {
        ...
        new DefaultGroup(1, 1, true, Optional.of(TEST_MESSAGE), sections);
    }
    ...
    public void canGetFirstSectionTypeInCorrectOrder() {
        ...
        Group group = new DefaultGroup(0, 2, true, Optional.of(TEST_MESSAGE), sections);
        assertEquals(CALL, group.getFirstSectionParseType());
    }

    @Test
    public void canSafelyCallToString() {
        Group group = new DefaultGroup(0, 1, true, Optional.of(TEST_MESSAGE), SECTIONS);
        group.toString();
    }
