...
public class DefaultLeadTest {
	...
	public void cantConstructLeadWithNullRows() {
		new DefaultLead(NumberOfBells.BELLS_8, null, empty);
	}

	@Test(expected=IllegalArgumentException.class)
	public void cantConstructLeadWithEmptyRows() {
		final Lead lead = new DefaultLead(NumberOfBells.BELLS_8, new ArrayList<>(), empty);
	...
	public void getHuntBellsReturnsEmptyCollectionWhenNumberOfRowsIsWrong() {
		...
		final Lead lead = new DefaultLead(NumberOfBells.BELLS_3, rows, empty);
