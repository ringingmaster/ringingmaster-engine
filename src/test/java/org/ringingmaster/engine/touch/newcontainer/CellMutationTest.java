...
public class CellMutationTest {
    ...
    public void hasCorrectDefault() throws Exception {
        ...
        assertEquals(0, touch.get().allCells().getColumnSize());
        assertEquals(0, touch.get().allCells().getRowSize());
    }
    ...
    public void addingCharactersToEmptyCellAddsCell() {
        ...
        assertEquals(1, touch.get().allCells().getColumnSize());
        assertEquals(1, touch.get().allCells().getRowSize());
        assertEquals("ABC", touch.get().allCells().get(0,0).getCharacters());
    }
    ...
    public void addingCharacterToExistingCellAppends() {
        ...
        assertEquals("ABC123", touch.get().allCells().get(0,0).getCharacters());
    }
    ...
    public void insertingCharacterToExistingCellInserts() {
        ...
        assertEquals("A123BC", touch.get().allCells().get(0,0).getCharacters());
    }
    ...
    public void removingSingleCharacterFromExistingCellDeletes() {
        ...
        assertEquals("AC", touch.get().allCells().get(0,0).getCharacters());
    }
    ...
    public void removingCharacterRangeFromExistingCellDeletes() {
        ...
        assertEquals("AD", touch.get().allCells().get(0,0).getCharacters());
    }
    ...
    public void removingAllCharactersRemovesCell() {
        ...
        assertEquals("", touch.get().allCells().get(0,0).getCharacters());
        assertTrue(touch.get().allCells().get(0,0) instanceof EmptyCell);
    }
    ...
    public void removingAllItemsInColumnCausesColumnRemoval() {
        ...
        assertEquals(3, touch.get().allCells().getColumnSize());

        touch.removeCharacters(0, 1, 0,3);
        assertEquals(2, touch.get().allCells().getColumnSize());
    }
    ...
    public void removingAllItemsInRowCausesRowRemoval() {
        ...
        assertEquals(3, touch.get().allCells().getRowSize());

        touch.removeCharacters(1, 0, 0,3);
        assertEquals(2, touch.get().allCells().getRowSize());
    }
